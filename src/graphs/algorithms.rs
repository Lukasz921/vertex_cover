...
pub fn find_vertex_cover(graph: Graph, k: usize) -> Option<Vec<Vertex>> {
...
pub fn find_vertex_cover_with_symplex(mut graph: Graph, mut k: usize, filename: &str) -> Option<Vec<Vertex>> {
